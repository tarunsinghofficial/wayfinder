...
<div class="mb-4 flex items-center justify-between rounded-lg bg-gray-100 p-4 shadow-md">
	<div class="text-center">
		<p class="text-sm font-semibold text-gray-500">{$t('trip.duration')}</p>
	...
	<div class="text-center">
		<p class="text-sm font-semibold text-gray-500">{$t('trip.start_time')}</p>
		<p class="text-lg font-bold text-gray-700">{formatTime(itinerary.startTime)}</p>
	</div>
	<div class="text-center">
		<p class="text-sm font-semibold text-gray-500">{$t('trip.end_time')}</p>
